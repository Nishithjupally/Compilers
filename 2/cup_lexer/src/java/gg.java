parser grammar cup_parser;

options {
    tokenVocab = cup_lexer;
}
...
expr returns [AST.expression value]:
        ...
        i=IDENTIFIER LPAREN el=expr_list RPAREN 
        | 
        // static dispatch
        ...
        wh=WHILE LPAREN e1=expr RPAREN LBRACE bel=block_expression_list RBRACE
        | 
        wh=WHILE LPAREN e1=expr RPAREN e2=expr SEMICOLON
        |
        // block expression
        // { e1; e2; e3; ... }
        ...
        |// e1 >> e2
        e1=expr GREATERGREATER e2=expr {
            $value = new AST.lt($e1.value, $e2.value, $e1.value.lineNo);
        }
        |
        // e1 >= e2
        ...
        |// e1 >>= e2
        e1=expr GREATERGREATEREQUAL e2=expr {
            $value = new AST.lt($e1.value, $e2.value, $e1.value.lineNo);
        }
        |
        // e1 = e2
