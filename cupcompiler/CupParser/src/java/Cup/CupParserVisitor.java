...
public interface CupParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link CupParser#globalDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGlobalDeclaration(CupParser.GlobalDeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CupParser#simpleDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSimpleDeclaration(CupParser.SimpleDeclarationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CupParser#dsDec}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDsDec(CupParser.DsDecContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CupParser#formal}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFormal(CupParser.FormalContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CupParser#nameList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNameList(CupParser.NameListContext ctx);
	/**
	 * Visit a parse tree produced by {@link CupParser#structDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStructDefinition(CupParser.StructDefinitionContext ctx);
}